...
export default class DisplayContactsFromJSON extends LightningElement {
    ...
    get arrayOfContactJSON() {
        console.log('this.contactJSON.records' + this.contactJSON.records);
        return this.contactJSON.records;
    }
}